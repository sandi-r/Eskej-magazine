...
importScripts('https://eskej-magazine.com/wp-content/plugins/chrome-push-notifications/assets/js/library/Dexie.min.js');
...
self.addEventListener('push', function(event) {
  ...
  event.waitUntil(self.registration.pushManager.getSubscription().then(function(subscription) {
   if (_webPushConfig.debug) console.log('Push sub data', subscription);
      return fetch('http://eskej-magazine.com/?subId='+ encodeURIComponent(subscription.endpoint)).then(function(response) {  
